namespace LMS {
	partial class AboutUs {
		...
		private void InitializeComponent() {
			...
			this.label1.Text = "Môn: Thực tập cơ sở ngành";
			// 
			// label2
			// 
			...
			this.label2.Text = "Mã lớp: 20192IT6040003";
			// 
			// label3
			// 
			...
			this.label3.Text = "Giáo viên hướng dẫn:  Nguyễn Thái Cường";
			// 
			// label4
			// 
			...
			this.label5.Size = new System.Drawing.Size(485, 80);
			this.label5.TabIndex = 4;
			this.label5.Text = "Đề tài: Tìm hiểu về lập trình winform trên C# và xây dựng ứng dụng cụ thể";
			// 
			// label6
			// 
			...
			this.label6.Text = "Phiên bản: 1.1 (demo)";
			// 
			// label7
			// 
			...
			this.label7.Text = "Phạm Quang Trung (nhóm trưởng)";
			// 
			// label8
			// 
			this.label8.AutoSize = true;
			this.label8.Font = new System.Drawing.Font("Segoe UI Semibold", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.label8.Location = new System.Drawing.Point(319, 322);
			this.label8.Name = "label8";
			this.label8.Size = new System.Drawing.Size(162, 21);
			this.label8.TabIndex = 7;
			this.label8.Text = "Lê Thị Hảo (winform)";
			// 
			// label9
			// 
			...
			this.label9.Text = "Dương Thị Huyền (sql)";
			// 
			// label10
			// 
			this.label10.AutoSize = true;
			this.label10.Font = new System.Drawing.Font("Segoe UI Semibold", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.label10.Location = new System.Drawing.Point(319, 382);
			this.label10.Name = "label10";
			this.label10.Size = new System.Drawing.Size(173, 21);
			this.label10.TabIndex = 9;
			this.label10.Text = "Nguyễn Thị Trang (sql)";
			// 
			// label11
			// 
			this.label11.AutoSize = true;
			this.label11.Font = new System.Drawing.Font("Segoe UI Semibold", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.label11.Location = new System.Drawing.Point(319, 412);
			this.label11.Name = "label11";
			this.label11.Size = new System.Drawing.Size(204, 21);
			this.label11.TabIndex = 10;
			this.label11.Text = "Nguyễn Hải Lâm (winform)";
			// 
			// pictureBox1
			// 
